...
`DOCS_SWITCHER=1 task docs-serve`, then use the palette and code-theme dropdowns,
...
[external links](https://github.com/mggg/gerrytools), and {doc}`internal links <user/install>`.
...
```python
#!/usr/bin/env python
"""Module docstring for a syntax-highlighting token sampler."""
...
:link: user/plotting/overview
:link-type: doc

This card links to the plotting guide.
:::
...
<a class="download-badge" href="https://github.com/mggg/gerrytools">Example badge</a>
